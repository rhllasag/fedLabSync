...
from the fedLabSync.bin folder.

Usage:
fedLabSync [--help] script [script args]... [--seed]
"""
...
import importlib
import pkgutil
from fedLabSync import bin, Defaults
from fedLabSync.version import __version__
...
def get_parser():
    ...
    parser.add_argument("script", help="Name of the fedLabSync script to run.",
                        choices=choices)
    parser.add_argument("--project_dir", type=str, default="./",
                        help='Path to FedLabSync project folder. '
...
def entry_func():
    ...
    # Import the script
    mod = importlib.import_module("fedLabSyn.bin." + script)
